...
Theoretical limits in the Gaussian additive error model \eqref{eq:model-additive} have also been studied in \cite{butucea2018variable} under the Hamming loss, $\E[\widehat{S}\triangle S]$.
