...
The degree-of-freedom parameter does not affect the asymptotic boundaries in both cases.
...
The optimality results also show that the exact support recovery problems can be substantially harder in the two-sided case compared to the one-sided alternative case in additive models, while the approximate support recovery problems are of equal difficulty.
...
A companion paper to the current work \cite{gao2019upass} analyzed asymptotic equivalences of several additional common association tests, and implements the power calculations in a software tool for visualization and forensics of reported findings in genetics.
