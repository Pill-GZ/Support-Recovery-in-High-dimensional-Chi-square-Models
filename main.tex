...
Two new boundaries are also identified in the Gaussian location model under one-sided alternatives.

We then elucidate on the nature of signal sizes in association tests by characterizing its relationship with the marginal frequencies, odds ratio, and sample sizes in simple $2\times2$ contingency tables. % in common association tests for binary traits.
...
We demonstrate, perhaps surprisingly, that balanced designs in case-control studies may {not} deliver the best power at a given sample size. % for detecting rare genetic variants with high odds ratios.
...
Together, these results lead to improved understanding of the power limits in high-dimensional screenings for categorical covariates, such as genome-wide association studies (GWAS).
...
I thank Professor Stilian Stoev for his generous support, and for encouraging me to pursue the current project.
I also thank Yuanzhi Li and Jinqi Shen for their careful proof-reading and thoughtful feedback on early versions of the manuscript.
