...
\begin{abstract}
We study the high-dimensional multiple testing problems in categorical variable screening, where test statistics have approximately chi-square distributions.
