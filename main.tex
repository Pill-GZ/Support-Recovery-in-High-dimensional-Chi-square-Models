...
\begin{frontmatter}
\title{\Large{High-dimensional Chi-square Models and Multiple Testing for Categorical Data}} %\thanksref{T1}} 
...
We further demonstrate, perhaps surprisingly, that balanced designs in case-control studies may \emph{not} deliver the best power. % for detecting rare genetic variants with high odds ratios.
...
\section{Numerical illustrations and evidence from GWAS}
\label{sec:numerical}
