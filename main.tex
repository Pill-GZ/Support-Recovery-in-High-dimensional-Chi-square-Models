...
\begin{abstract}
We study high-dimensional multiple testing problems where test statistics have approximate chi-square distributions, typified by categorical variable screenings such as genome-wide association studies (GWAS).
